...
echo "###############################"
#bash tools/train.sh  configs/mva2023_centripetalnet/centripetalnet_140e_coco.py
...
echo "###############################"
bash tools/train.sh  configs/mva2023_centripetalnet/centripetalnet_140e_coco_finetune.py
...
echo "###############################"
CONFIG=configs/mva2023_centripetalnet/centripetalnet_140e_coco_hard_negative.py
CHECKPOINT=work_dirs/centripetalnet_140e_coco_finetune/latest.pth
...
echo "###############################"
bash tools/train.sh  configs/mva2023_centripetalnet/centripetalnet_140e_coco_hard_negative_training.py
...
echo "###############################"
bash tools/test.sh configs/mva2023_centripetalnet/centripetalnet_140e_coco_inference.py work_dirs/centernet_resnet18_140e_coco_hard_negative_training/latest.pth --format-only --eval-options jsonfile_prefix=results
