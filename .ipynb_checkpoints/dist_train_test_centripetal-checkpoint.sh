...
echo "###############################"
#bash tools/dist_train.sh  configs/mva2023_centripetalnet/centripetalnet_140e_coco.py $GPU_NUM
...
echo "###############################"
#bash tools/dist_train.sh  configs/mva2023_centripetalnet/centripetalnet_140e_coco_finetune.py $GPU_NUM
...
echo "###############################"
CONFIG=configs/mva2023_centripetalnet/centripetalnet_140e_coco_sample_hard_negative.py
CHECKPOINT=work_dirs/centripetalnet_140e_coco_finetune/epoch_40.pth #
NNODES=${NNODES:-1}
...
python -m torch.distributed.launch \
 ...
 hard_neg_example_tools/test_hard_neg_example.py \
    ...
    --hard-negative-file work_dirs/centripetalnet_140e_coco_finetune/train_coco_hard_negative.json \
...
echo "###############################"
bash tools/dist_train.sh  configs/mva2023_centripetalnet/centripetalnet_140e_coco_hard_negative_training.py $GPU_NUM
...
echo "###############################"
bash tools/dist_test.sh configs/mva2023_centripetalnet/centripetalnet_140e_coco_inference.py work_dirs/centripetalnet_140e_coco_hard_negative_training/epoch_20.pth \ #
