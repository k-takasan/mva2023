...
import os
_base_ = './centernet_resnet101_140e_coco.py'
...
data = dict(
    train=dict(
        hard_negative_file=LIB_ROOT_DIR + '/work_dirs/centernet_resnet101_140e_coco_finetune/train_coco_hard_negative.json',  # ---
...
load_from = LIB_ROOT_DIR + '/work_dirs/centernet_resnet101_140e_coco_finetune/epoch_20.pth'
